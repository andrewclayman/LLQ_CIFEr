...
# Paper configuration: the 6 rolling windows P1-P6 (3yr training -> 1yr OOS)
# reported in Table II. This is the default so the repo reproduces the paper.
WALK_FORWARD_PERIODS = [
    ('2015-01-01', '2017-12-31', '2018-01-01', '2018-12-31'),  # P1 -> OOS 2018
    ('2017-01-01', '2019-12-31', '2020-01-01', '2020-12-31'),  # P2 -> OOS 2020
    ('2018-01-01', '2020-12-31', '2021-01-01', '2021-12-31'),  # P3 -> OOS 2021
    ('2019-01-01', '2021-12-31', '2022-01-01', '2022-12-31'),  # P4 -> OOS 2022
    ('2020-01-01', '2022-12-31', '2023-01-01', '2023-12-31'),  # P5 -> OOS 2023
    ('2021-01-01', '2023-12-31', '2024-01-01', '2024-12-31'),  # P6 -> OOS 2024
    # Optional extension beyond the paper (uncomment to add a 7th OOS year, 2025):
...
# One entry per paper period P1-P6 (validation year never overlaps the OOS test year).
TUNING_WALK_FORWARD_PERIODS = [
    ('2015-01-01', '2016-12-31', '2017-01-01', '2017-12-31'),  # P1
    ('2017-01-01', '2018-12-31', '2019-01-01', '2019-12-31'),  # P2
    ('2018-01-01', '2019-12-31', '2020-01-01', '2020-12-31'),  # P3
    ('2019-01-01', '2020-12-31', '2021-01-01', '2021-12-31'),  # P4
    ('2020-01-01', '2021-12-31', '2022-01-01', '2022-12-31'),  # P5
    ('2021-01-01', '2022-12-31', '2023-01-01', '2023-12-31'),  # P6
    # Optional extension (7th period, for the 2025 OOS year above):
